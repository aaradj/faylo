  ...
  return (
    <Main>
      <Div>
        ...
        <CHead>Access your files, anywhere</CHead>
        <CPara>
          The ability to use a samrtphone, table, or computer to access your
      ...
      <Div>
        ...
        <CHead>Securiry you caan trust</CHead>
        <CPara>
          2-factor authentication and user-controlled encyption are just a
      ...
      <Div>
        ...
        <CHead>Real-time collaboration</CHead>
        <CPara>
          Securly share files and floders with friends, family and colleages for
      ...
      <Div>
        ...
        <CHead>Store any type of file</CHead>
        <CPara>
          Whether you're sharing helodays photos or work documents, Fylo has you
          coverd allowing for all file types to be securely stored and shared{" "}
        </CPara>
      </Div>
    </Main>
  );
